...
def aplicar_questionario():
    ...
    questoes = [
        {
            "dimensao": "dimensao_compreensao", #Sequencial vs, Global
            "numero": 1,
        ...
        {
            "dimensao": "dimensao_percepcao", #Sensorial vs, Intuitivo
            "numero": 2,
        ...
        {
            "dimensao": "dimensao_entrada", #Visual vs, Verbal
            "numero": 3,
        ...
        {
            "dimensao": "dimensao_processamento", #Ativo vs, Reflexivo
            "numero": 4,
